  ...
  return (
    <div className="w-full flex flex-col justify-center  items-center  py-4 md:px-56 bg-white/30 backdrop-blur border border-pink-200  shadow-md shadow-pink-100">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center text-start px-4 md:text-xl text-lg w-full">
        <h2 className="font-bold  text-4xl max-md:text-3xl mt-2 mb-4  tracking-wider">Contact Me</h2>
       <Link href="https://www.linkedin.com/in/nisreen-bouta/" target='_blank'> <h2 className="flex flex-row justify-center items-center gap-2 font-light  tracking-wider hover:text-pink-400 duration-150 ease-linear cursor-pointer"  >
          <SiLinkedin /> LinkedIn
        </h2>
        </Link>
        ...
        <h2 className="flex flex-row justify-center items-center gap-2 font-extralight tracking-wider text-[16px] max-md:text-xs mt-6">💖 Designed & built by Nisreen Bouta</h2>
      </div>
    </div>
    </div>
  )
